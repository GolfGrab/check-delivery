...
function HeaderAndForm({ phoneInput, handleSubmit }) {
  return (
    <div className="  flex max-w-[20rem] items-center justify-center     px-[1.5rem] py-[3rem]">
      <main className="">
        {/* header section */}
        <h1 className="mb-[1.5rem]  text-center text-4xl font-bold text-[#9b83f1] underline decoration-[#fa9ff5] decoration-wavy decoration-2">
          Friendteamsweet
        </h1>
        {/* form section */}
        ...
        <div className="mx-10 flex items-center justify-end pt-[0.75rem]">
          ...
          <a
            ...
            href="https://twitter.com/jisungmommyy/"
            target="_blank"
